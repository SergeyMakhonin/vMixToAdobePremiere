data class Segment(
    ...
    val fileName: String,
    val offline: Boolean,
    val timeStampTimeCode: TimeCode = timeStampToTimeCode(timeStamp)
)

// timeStamp example 2020-01-29T23:15:49.0003729+03:00
fun timeStampToTimeCode(timeStamp: String): TimeCode {
    ...
    val frames = secondsDotFrames[1].split("+")[0]
    val tzDelta = secondsDotFrames[1].split("+")[1]
    return TimeCode(timeParts[0].toInt(), timeParts[1].toInt(), seconds, 0)
}
